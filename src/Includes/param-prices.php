        ...
        <div class="parameters-modal-form">
            ...
            <form id="pricingForm">
                ...
                <div class="mb-3" id="individualFields">
                    ...
                    <div class="invalid-feedback" id="parameterIdError">Please select a parameter.</div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" min="0" class="parameters-form-control" id="testCharge" placeholder="0.00">
                    <div class="invalid-feedback" id="testChargeError">Please enter a valid price (0 or more).</div>
                </div>
                <div class="mb-3">
...
<script>
    ...
    async function loadPrices(filters = {}) {
        ...
        if (!hasRows) {
            tableBody.innerHTML = '<tr><td colspan="5" class="text-center text-muted">No prices found</td></tr>';
        }
    }
    ...
    pricingForm.addEventListener('submit', async (e) => {
        ...
        // Frontend Validation
        if (!data.test_charge || isNaN(data.test_charge) || parseFloat(data.test_charge) < 0) {
        ...
        btnSave.innerHTML = '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Processing...';
