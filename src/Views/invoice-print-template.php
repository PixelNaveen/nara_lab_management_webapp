        ...
        <div class="letterhead">
            ...
            <div class="agency-text">
                <div class="sinhala-line">
                    ...
                    <span>සහ</span>
                    <span>සංවර්ධන</span>
                    <span>නියෝජිතායතනය</span>
                </div>
                <div class="tamil-line">
                    <span>தேசிய</span>
                    <span>நீரியல்வள</span>
                    <span>ஆராய்ச்சி</span>
                    <span>அபிவிருத்தி</span>
                    <span>முகாமை</span>
                </div>
                ...
                <div class="address-line">
                    <span>කාක දූපත, මට්ටක්කුලිය, කොළඹ 15.</span>
                    <span>காக்கை தீவு, மட்டக்குளி, கொழும்பு 15.</span>
        ...
        <footer class="invoice-footer">
            <div class="footer-columns">
                <div class="footer-col">
                    <div class="footer-col-title">Chairman</div>
                    <div class="footer-row">
                        <span class="footer-label">Tel</span><span>: 011 2521176 / 2521881</span>
                    </div>
                    <div class="footer-row">
                        <span class="footer-label">Fax</span><span>: 011 2521881</span>
                    </div>
                    <div class="footer-row">
                        <span class="footer-label">Email</span><span>: chairman@nara.ac.lk</span>
                    </div>
                </div>
                <div class="footer-col">
                    <div class="footer-col-title">Director General</div>
                    <div class="footer-row">
                        <span class="footer-label">Tel</span><span>: 011 2521932</span>
                    </div>
                    <div class="footer-row">
                        <span class="footer-label">Fax</span><span>: 011 2521932</span>
                    </div>
                    <div class="footer-row">
                        <span class="footer-label">Email</span><span>: dg@nara.ac.lk</span>
                    </div>
                    <div class="footer-row">
                        <span class="footer-label">Web</span><span>: http://www.nara.ac.lk</span>
                    </div>
                </div>
                <div class="footer-col">
                    <div class="footer-col-title">General</div>
                    <div class="footer-row">
                        <span class="footer-label">Tel</span><span>: 011 2521000 / 2521006</span>
                    </div>
                    <div class="footer-row">
                        <span class="footer-label">Email</span><span>: postmaster@nara.ac.lk</span>
                    </div>
                </div>
            </div>
        </footer>
