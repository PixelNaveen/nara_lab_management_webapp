...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2025 at 03:29 PM
...
(6, 'KNJ Lab', 'Kalutara', 'Kaluthara', '0763740019', 'Kavidu Naveen', '2025-12-14', 1, '2025-12-14 09:05:58', '2025-12-14 09:18:51');
...
INSERT INTO `samples` (`sample_id`, `client_id`, `sample_code`, `form_number`, `report_ref`, `submission_type`, `received_date`, `tentative_date`, `submitted_by`, `additional_notes`, `additional_charges`, `test_charges_total`, `grand_total`, `payment_status`, `payment_reference`, `payment_date`, `forms_generated`, `generated_at`, `created_at`) VALUES
(3, 6, '25/0001/01', '25/0001/01', '25/0001', 'regular', '2025-12-14', '2025-12-21', 'Kavidu Naveen', 'Do your best', 100.00, 2500.00, 2600.00, 'Not Paid', NULL, NULL, 0, NULL, '2025-12-14 14:26:23'),
(4, 6, '25/0002/01', '25/0002/01', '25/0002', 'regular', '2025-12-14', '2025-12-21', 'Kavidu Naveen', 'Do your best', 100.00, 2500.00, 2600.00, 'Not Paid', NULL, NULL, 0, NULL, '2025-12-14 14:26:23');
...
(3, 3, 'AC/25/0001/01', 'Kavidu Naveen', 'No', 'Ambient', 'OK', '2025-12-21', NULL, '2025-12-14 14:26:23'),
(4, 4, 'AC/25/0002/01', 'Kavidu Naveen', 'No', 'Ambient', 'OK', '2025-12-21', NULL, '2025-12-14 14:26:23');
...
(3, 3, 'AC/25/0001/01', NULL, 2500.00, 100.00, 2600.00, 'Not Paid', NULL, NULL, 'Kavidu Naveen', '2025-12-14 14:26:23', 'Do your best', '2025-12-14 14:26:23'),
(4, 4, 'AC/25/0002/01', NULL, 2500.00, 100.00, 2600.00, 'Not Paid', NULL, NULL, 'Kavidu Naveen', '2025-12-14 14:26:23', 'Do your best', '2025-12-14 14:26:23');
...
(3, 3, 'Drinking Water', '100', 'ml', 'Test-01', 'Office lab', 'Export', 'No', 'Ambient', 'OK', 1, 0.00, '2025-12-14 14:26:23'),
(4, 4, 'Drinking Water', '100', 'ml', 'Test-01', 'Office lab', 'Export', 'No', 'Ambient', 'OK', 1, 0.00, '2025-12-14 14:26:23');
...
(1, 'Drinking Water', 11, '2025-11-20 10:05:02', '2025-12-14 14:26:23'),
...
(5, 'Treated Water', 1, '2025-12-07 17:07:24', NULL);
...
(5, NULL, 3, 1, 3, 1, 1250.00, 0, 0, '2025-12-14 14:26:23'),
(6, NULL, 3, 1, 2, 1, 1250.00, 0, 0, '2025-12-14 14:26:23'),
(7, NULL, 4, 1, 3, 1, 1250.00, 0, 0, '2025-12-14 14:26:23'),
(8, NULL, 4, 1, 2, 1, 1250.00, 0, 0, '2025-12-14 14:26:23');
...
--
ALTER TABLE `sample_acknowledgement`
  MODIFY `ack_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `sample_items`
--
ALTER TABLE `sample_items`
  MODIFY `sample_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `sample_names`
--
ALTER TABLE `sample_names`
  MODIFY `sample_name_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `sample_tests`
--
ALTER TABLE `sample_tests`
  MODIFY `sample_test_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
